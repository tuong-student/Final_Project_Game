...
public class BasicEditorStyles
{
    ...
    public static GUIStyle AlignLabelMiddleCenter => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleCenter };
    public static GUIStyle AlignLabelMiddleLeft => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleLeft };
    public static GUIStyle AlignLabelMiddleRight => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleRight};
    public static GUIStyle AlignLabelLowerCenter => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.LowerCenter};
    public static GUIStyle AlignLabelLowerLeft => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.LowerLeft};
    public static GUIStyle AlignLabelLowerRight => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.LowerRight};
    public static GUIStyle AlignLabelUpperCenter => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.UpperCenter};
    public static GUIStyle AlignLabelUpperLeft => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.UpperLeft};
    public static GUIStyle AlignLabelUpperRight => new GUIStyle(GUI.skin.label) { alignment = TextAnchor.UpperRight};
    public static GUIStyle FontSize(int size)
    {
        return new GUIStyle(GUI.skin.label) { fontSize = size };
    }
}
